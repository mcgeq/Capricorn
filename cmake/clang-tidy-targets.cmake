...
add_custom_target(
    ...
    -D "CLANG_TIDY_CONFIG_FILE=${template_clang_tidy_config_file}"
    -D "CLANG_TIDY_HEADER_FILTER=${template_clang_tidy_header_filter}"
    -D "CLANG_TIDY_WARNINGS_AS_ERRORS=${template_clang_tidy_warnings_as_errors}"
