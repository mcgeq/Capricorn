...
hidden if the `Capricorn_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `Capricorn_DEVELOPER_MODE` to the configure
...
Runs the executable target `Capricorn_exe`.
